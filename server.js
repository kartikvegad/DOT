        ...
        const adminMailOptions = {
            ...
            html: `
                <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 24px; background: #0a0a0a; color: #f0f0f0; border-radius: 12px;">
                    <h2 style="color: #4BC772; border-bottom: 1px solid #222; padding-bottom: 12px;">📨 New Contact Inquiry</h2>
                    <table style="width: 100%; border-collapse: collapse; margin-top: 16px;">
                        ...
                        <tr><td style="padding: 8px 0; color: #888;">Email</td><td style="padding: 8px 0;"><a href="mailto:${user_email}" style="color: #4BC772;">${user_email}</a></td></tr>
                        <tr><td style="padding: 8px 0; color: #888;">Phone</td><td style="padding: 8px 0;"><a href="tel:${phone}" style="color: #4BC772;">${phone}</a></td></tr>
            ...
            html: `
                <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 32px; background: #0a0a0a; color: #f0f0f0; border-radius: 12px;">
                    ...
                    <p style="color: #aaa; line-height: 1.7;">
                        ...
                        <a href="mailto:${process.env.EMAIL_USER}" style="color: #4BC772;">${process.env.EMAIL_USER}</a>.
                    </p>
